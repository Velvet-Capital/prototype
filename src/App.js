...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const SwapContract = new web3.eth.Contract(IndexSwap.abi, "0x38Cc157D354D627e2D05F4f37202baDAD14C84b1");
    const NFTPortfolioContract = new web3.eth.Contract(NFTSwap.abi, "0xC8486cd132703aAb7679C0A95FC6A94f5fE1e50E");
  ...
  approveNFTTokens = async() => {
    ...
    await aXSTokenConntract.methods.approve("0xC8486cd132703aAb7679C0A95FC6A94f5fE1e50E", "115792089237316195423570985008687907853269984665640564039457584007913129639935").send({ from: "0x6056773C28c258425Cf9BC8Ba5f86B8031863164" });

    const mANATokenConntract = new web3.eth.Contract(IERC.abi, "0x8bf2dF0Ff8528088475183a68678bd1Cd7691b69");
    await mANATokenConntract.methods.approve("0xC8486cd132703aAb7679C0A95FC6A94f5fE1e50E", "115792089237316195423570985008687907853269984665640564039457584007913129639935").send({ from: "0x6056773C28c258425Cf9BC8Ba5f86B8031863164" });

    const sANDTokenConntract = new web3.eth.Contract(IERC.abi, "0x1631A54AC95Ecb0085dB6b8ACf80c4Cee72AEB06");
    await sANDTokenConntract.methods.approve("0xC8486cd132703aAb7679C0A95FC6A94f5fE1e50E", "115792089237316195423570985008687907853269984665640564039457584007913129639935").send({ from: "0x6056773C28c258425Cf9BC8Ba5f86B8031863164" });

    const tHETATokenConntract = new web3.eth.Contract(IERC.abi, "0x19A5E53eC7B385dbE2E587Ba989eA2AB8F7EaF1e");
    await tHETATokenConntract.methods.approve("0xC8486cd132703aAb7679C0A95FC6A94f5fE1e50E", "115792089237316195423570985008687907853269984665640564039457584007913129639935").send({ from: "0x6056773C28c258425Cf9BC8Ba5f86B8031863164" });

    const fLOWTokenConntract = new web3.eth.Contract(IERC.abi, "0xe5c48084E1974a971Bd5dF4d9B01daCCA86d5567");
    await fLOWTokenConntract.methods.approve("0xC8486cd132703aAb7679C0A95FC6A94f5fE1e50E", "115792089237316195423570985008687907853269984665640564039457584007913129639935").send({ from: "0x6056773C28c258425Cf9BC8Ba5f86B8031863164" });

    const xTZTokenConntract = new web3.eth.Contract(IERC.abi, "0xC5De9d5B0BA5b408a3e9530A1BC310d8F2dCC26a");
    await xTZTokenConntract.methods.approve("0xC8486cd132703aAb7679C0A95FC6A94f5fE1e50E", "115792089237316195423570985008687907853269984665640564039457584007913129639935").send({ from: "0x6056773C28c258425Cf9BC8Ba5f86B8031863164" });

    const gALATokenConntract = new web3.eth.Contract(IERC.abi, "0x4bf1CE8E4c4c86126E57Fa9fc3f1a9631661641c");
    await gALATokenConntract.methods.approve("0xC8486cd132703aAb7679C0A95FC6A94f5fE1e50E", "115792089237316195423570985008687907853269984665640564039457584007913129639935").send({ from: "0x6056773C28c258425Cf9BC8Ba5f86B8031863164" });

    const cHZTokenConntract = new web3.eth.Contract(IERC.abi, "0xdeEC6f0C22970b9b8a47069bE619bfAe646dEe26");
    await cHZTokenConntract.methods.approve("0xC8486cd132703aAb7679C0A95FC6A94f5fE1e50E", "115792089237316195423570985008687907853269984665640564039457584007913129639935").send({ from: "0x6056773C28c258425Cf9BC8Ba5f86B8031863164" });

    const eNJTokenConntract = new web3.eth.Contract(IERC.abi, "0xb08A1959f57b9cC8e5A5F1d329EfD90EE3438F65");
    await eNJTokenConntract.methods.approve("0xC8486cd132703aAb7679C0A95FC6A94f5fE1e50E", "115792089237316195423570985008687907853269984665640564039457584007913129639935").send({ from: "0x6056773C28c258425Cf9BC8Ba5f86B8031863164" });
  ...
  withdrawDeFi = async () => {
    ...
    await this.state.DeFiTokenContract.methods.approve("0x38Cc157D354D627e2D05F4f37202baDAD14C84b1", "7787357773333787487837458347754874574837458374")
  ...
  withdrawNFT = async () => {
      ...
      await this.state.NFTTokenContract.methods.approve("0xC8486cd132703aAb7679C0A95FC6A94f5fE1e50E", "7787357773333787487837458347754874574837458374")
      .send({from: this.state.account});
  ...
  calcTokenBalances = async () => {
    ...
    const lunaTokenBalanceRes = await LUNATokenConntract.methods.balanceOf("0x6056773C28c258425Cf9BC8Ba5f86B8031863164").call();
    ...
    const stethTokenBalanceRes = await STETHTokenConntract.methods.balanceOf("0x6056773C28c258425Cf9BC8Ba5f86B8031863164").call();
    ...
    const SANDTokenConntract = new web3.eth.Contract(IERC.abi, "0x1631A54AC95Ecb0085dB6b8ACf80c4Cee72AEB06");
    const sandTokenBalanceRes = await SANDTokenConntract.methods.balanceOf("0x6056773C28c258425Cf9BC8Ba5f86B8031863164").call();
    ...
    const THETATokenConntract = new web3.eth.Contract(IERC.abi, "0x19A5E53eC7B385dbE2E587Ba989eA2AB8F7EaF1e");
    const thetaTokenBalanceRes = await THETATokenConntract.methods.balanceOf("0x6056773C28c258425Cf9BC8Ba5f86B8031863164").call();
    ...
    const FLOWTokenConntract = new web3.eth.Contract(IERC.abi, "0xe5c48084E1974a971Bd5dF4d9B01daCCA86d5567");
    const flowTokenBalanceRes = await FLOWTokenConntract.methods.balanceOf("0x6056773C28c258425Cf9BC8Ba5f86B8031863164").call();
    ...
    const XTZTokenConntract = new web3.eth.Contract(IERC.abi, "0xC5De9d5B0BA5b408a3e9530A1BC310d8F2dCC26a");
    const xtzTokenBalanceRes = await XTZTokenConntract.methods.balanceOf("0x6056773C28c258425Cf9BC8Ba5f86B8031863164").call();
    ...
    const GALATokenConntract = new web3.eth.Contract(IERC.abi, "0x4bf1CE8E4c4c86126E57Fa9fc3f1a9631661641c");
    const galaTokenBalanceRes = await GALATokenConntract.methods.balanceOf("0x6056773C28c258425Cf9BC8Ba5f86B8031863164").call();
    ...
    const CHZTokenConntract = new web3.eth.Contract(IERC.abi, "0xdeEC6f0C22970b9b8a47069bE619bfAe646dEe26");
    const chzTokenBalanceRes = await CHZTokenConntract.methods.balanceOf("0x6056773C28c258425Cf9BC8Ba5f86B8031863164").call();
    ...
    const ENJTokenConntract = new web3.eth.Contract(IERC.abi, "0xb08A1959f57b9cC8e5A5F1d329EfD90EE3438F65");
    const enjTokenBalanceRes = await ENJTokenConntract.methods.balanceOf("0x6056773C28c258425Cf9BC8Ba5f86B8031863164").call();
    ...
    const ROSETokenConntract = new web3.eth.Contract(IERC.abi, "0x30c1AC77F4068A063648B549ffF96Ddb9d151325");
    const roseTokenBalanceRes = await ROSETokenConntract.methods.balanceOf("0x6056773C28c258425Cf9BC8Ba5f86B8031863164").call();
